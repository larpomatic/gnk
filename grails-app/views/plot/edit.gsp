...
<html>
	...
	<body>
		<a href="#edit-plot" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-plot" class="content scaffold-edit" role="main">
