...
<html>
	...
	<body>
		<a href="#edit-genericPlace" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-genericPlace" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${genericPlaceInstance?.version}" />
				<fieldset class="form">
