...
<body>
	...
	<div id="edit-plot" class="content scaffold-list" role="main">
        ...
        <g:link action="getBack" controller="selectIntrigue" id="${gnInstance.id}" class="btn btn-primary pull-right"><g:message code="default.back.label" default="Back"/></g:link>
