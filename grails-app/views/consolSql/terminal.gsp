    ...
    <g:hasRights lvlright="${right.RIGHTSHOW.value()}">
        ...
        <ul class="nav nav-pills">
            ...
            <g:hasRights lvlright="${right.USEROPEN.value()}">
                ...
                <li class="active"><g:link controller="consolSql" action="terminal"><g:message
                        code="navbar.gestion_console"/></g:link></li>
            </g:hasRights>
        ...
        <div role="main">
                                    ...
                                    <ul>
                                        <li>
                                            <g:each in="${ls.sqlRequest}" var="rq">
                                                <a class="requestLink" href="#"
                                                   data-request="${rq.sqlrequest}">${rq.name}</a>
                                            </g:each>
                                        </li>
                                    </ul>
                                </g:each>
            ...
            <g:hasRights lvlright="${right.REFDELETE.value()}">
                ...
                <g:form action="deleteRequest" method="post">
                    <div id="delSelect">
                        <label><g:message code="gnk.consol.cat"/></label><select name="categoryname" id="categorynameD"
                                                                                 data-url="<g:createLink
                                                                                         controller="consolSql"
                        ...
                        <label><g:message code="gnk.consol.subcat"/></label><select name="subcategory" id="subcategoryD"
                                                                                    data-url="<g:createLink
                                                                                            controller="consolSql"
                                                                                            action="getRequest"/>">
                        <option value=""></option>
                    </select><br/>
                        <label><g:message code="gnk.consol.request"/></label> <select name="requestname"
                                                                                      id="requestnameD">
                        <option value=""></option>
                    </select><br/>
                    </div>
