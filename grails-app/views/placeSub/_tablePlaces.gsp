                        ...
                        <g:if test="${!(Tag.findByName("Tag Univers").id == placeHasTags.tag.parent.id)}">
                            ...
                            <g:form class="form-small">
                                ...
                                <g:hasRights lvlright="${right.REFDELETE.value()}">
                                    <g:actionSubmit class="icon-remove remove-action" controller="placeSub" action="deleteTag" value=" " onclick="return confirm('${message(code: 'adminRef.place.deleteTag')}');" />
                                </g:hasRights>
                            </g:form>
                        </li>
                        </g:if>
