...
<div id="modal${tag.id}" class="modal hide" style="width: 800px; margin-left: -400px; z-index: 9999;"
...
<g:if test="${tag.getTagRelevant()}">
    ...
    <table class="table table-condensed" style="width: 25%">
        ...
        <tr>
            ...
            <td><g:if test="${tag.getTagRelevant().relevantFirstname}">
                <g:img dir="images/tag" file="true.png" width="30" height="30"/>
            </g:if>
            </td>
        </tr>
        <tr>
            <td>RelevantLastname</td>
            <td><g:if test="${tag.getTagRelevant().relevantLastname}">
                <g:img dir="images/tag" file="true.png" width="30" height="30"/>
            </g:if></td>
        </tr>
        <tr>
            <td>RelevantResource</td>
            <td><g:if test="${tag.getTagRelevant().relevantResource}">
                <g:img dir="images/tag" file="true.png" width="30" height="30"/>
            </g:if></td>
        </tr>
        <tr>
            <td>RelevantPlot</td>
            <td><g:if test="${tag.getTagRelevant().relevantPlot}">
                <g:img dir="images/tag" file="true.png" width="30" height="30"/>
            </g:if></td>
        </tr>
        <tr>
            <td>RelevantRole</td>
            <td><g:if test="${tag.getTagRelevant().relevantRole}">
                <g:img dir="images/tag" file="true.png" width="30" height="30"/>
            </g:if></td>
        </tr>
        <tbody>
